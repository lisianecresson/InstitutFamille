    ...
    <div class="navbar navbar-default yamm" role="navigation" id="navbar">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="{{ route('accueil') }}" data-animate-hover="bounce">
                    <img src={{ asset("img/logo.png") }}  alt="Institut famille logo" class="hidden-xs">
                    <img src={{ asset("img/logo.png") }} alt="Institut famille logo" class="visible-xs"><span class="sr-only">Institut famille - Accueil</span>
                </a>
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">E-learning <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
